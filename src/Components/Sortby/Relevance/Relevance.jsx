...
export default function Relevance() {
    ...
    const [relevance, setRelevanceGames] = useState([]);
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {relevance.length > 0 ? relevance.slice(0, count).map((game, index) =>
            ...
            {count > relevance.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}

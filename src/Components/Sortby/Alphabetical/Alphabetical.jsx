...
export default function Alphabetical() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {alphabeticalGames.length > 0 ? alphabeticalGames.slice(0, count).map((game, index) =>
            ...
            {count > alphabeticalGames.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
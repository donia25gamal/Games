...
export default function ActionRpg() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {actionRpg.length > 0 ? actionRpg.slice(0, count).map((game, index) =>
            ...
            {count > actionRpg.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
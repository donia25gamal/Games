...
export default function Racing() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {racing.length > 0 ? racing.slice(0, count).map((game, index) =>
            ...
            {count > racing.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
...
export default function Sports() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {sports.length > 0 ? sports.slice(0, count).map((game, index) =>
            ...
            {count > sports.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
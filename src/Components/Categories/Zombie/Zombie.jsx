...
export default function Zombie() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {zombie.length > 0 ? zombie.slice(0, count).map((game, index) =>
            ...
            {count > zombie.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
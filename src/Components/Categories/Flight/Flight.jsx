...
export default function Flight() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {flight.length > 0 ? flight.slice(0, count).map((game, index) =>
            ...
            {count > flight.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
...
export default function Social() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {social.length > 0 ? social.slice(0, count).map((game, index) =>
            ...
            {count > social.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
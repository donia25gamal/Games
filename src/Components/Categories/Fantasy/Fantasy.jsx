...
export default function Fantasy() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {fantasy.length > 0 ? fantasy.slice(0, count).map((game, index) =>
            ...
            {count > fantasy.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
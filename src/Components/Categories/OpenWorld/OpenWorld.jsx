...
export default function OpenWorld() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {openWorld.length > 0 ? openWorld.slice(0, count).map((game, index) =>
            ...
            {count > openWorld.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
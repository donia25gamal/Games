...
export default function OpenWorld() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {shooter.length > 0 ? shooter.slice(0, count).map((game, index) =>
            ...
            {count > shooter.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
...
export default function Pc() {
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {pcGames.length > 0 ? pcGames.slice(0, count).map((game, index) =>
            ...
            {count > pcGames.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}
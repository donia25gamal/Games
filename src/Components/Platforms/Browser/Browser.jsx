...
export default function Browser() {
    ...
    const [Browser, setBrowserGames] = useState([]);
    ...
    return <>
        <div className="container text-center">
            <div className="row">
                {Browser.length > 0 ? Browser.slice(0, count).map((game, index) =>
            ...
            {count > Browser.length ? null : <button onClick={moreGames} className='btn btn-outline-secondary'>More Games</button>}
        </div>
    </>
}